...
apt-get update
apt-get install -y apache2 libapache2-mod-php7.2 composer php7.2-curl php-xml php-zip php-mbstring php-yaml php-json php-http python3-venv libpq-dev postgresql-common
